...
import com.rodolpho.study.entities.*;
import com.rodolpho.study.entities.enums.OrderStatus;
import com.rodolpho.study.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2022-06-20T19:53:07Z"), OrderStatus.DELIVERED, u1);
        Order o2 = new Order(null, Instant.parse("2022-07-21T03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2);
        Order o3 = new Order(null, Instant.parse("2022-07-22T15:21:22Z"), OrderStatus.PAID, u1);
        ...
        Payment pay1 = new Payment(null, Instant.parse("2022-07-22T17:21:22Z"), o3);
        o3.setPayment(pay1);
